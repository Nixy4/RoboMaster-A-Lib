...
inline quad_coord leg_coord_offset(leg_index index ,quad_coord c)
{
  switch(index) {
    case LEG_RF:
      c.X += (CONFIG_LEG_COORD_OFFSET_RF_X+CONFIG_LEG_COORD_OFFSET_GLOBAL_X);
      c.Z += (CONFIG_LEG_COORD_OFFSET_RF_Z+CONFIG_LEG_COORD_OFFSET_GLOBAL_Z);
      break;
    case LEG_LF:
      c.X += (CONFIG_LEG_COORD_OFFSET_LF_X+CONFIG_LEG_COORD_OFFSET_GLOBAL_X);
      c.Z += (CONFIG_LEG_COORD_OFFSET_LF_Z+CONFIG_LEG_COORD_OFFSET_GLOBAL_Z);
      break;
    case LEG_RB:
      c.X += (CONFIG_LEG_COORD_OFFSET_RB_X+CONFIG_LEG_COORD_OFFSET_GLOBAL_X);
      c.Z += (CONFIG_LEG_COORD_OFFSET_RB_Z+CONFIG_LEG_COORD_OFFSET_GLOBAL_Z);
      break;
    case LEG_LB:
      c.X += (CONFIG_LEG_COORD_OFFSET_LB_X+CONFIG_LEG_COORD_OFFSET_GLOBAL_X);
      c.Z += (CONFIG_LEG_COORD_OFFSET_LB_Z+CONFIG_LEG_COORD_OFFSET_GLOBAL_Z);
      break;
    default:
